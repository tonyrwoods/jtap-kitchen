      ...
      body: `
        <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          ...
          <div style="padding: 40px 32px; background-color: #faf9f7;">
            ...
            <p style="color: #666; margin-bottom: 24px;">Hi ${ticket.requester_name}, we're happy to let you know that your support request has been resolved.</p>
            <div style="background: #fff; border: 1px solid #e8e2d8; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
              ...
              <p style="font-size: 16px; font-weight: 600; margin: 0 0 20px;">${ticket.subject}</p>
              <p style="color: #999; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 6px;">Resolution Summary</p>
              <p style="font-size: 14px; color: #444; line-height: 1.6; margin: 0;">${resolution}</p>
            </div>
