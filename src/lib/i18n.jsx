...
const TRANSLATIONS = {
  en: {
    nav: { menu: "Menu", story: "Our Story", gallery: "Gallery", team: "Our Team", reviews: "Reviews", reserve: "Reserve", book: "Book a Table" },
  ...
  fr: {
    nav: { menu: "Menu", story: "Notre Histoire", gallery: "Galerie", team: "Notre Équipe", reviews: "Avis", reserve: "Réserver", book: "Réserver une Table" },
  ...
  es: {
    nav: { menu: "Menú", story: "Nuestra Historia", gallery: "Galería", team: "Nuestro Equipo", reviews: "Reseñas", reserve: "Reservar", book: "Reservar Mesa" },
