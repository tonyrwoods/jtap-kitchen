      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 font-body text-sm text-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>
              Welcome to JTAP Kitchen ("we," "our," or "us"). We are committed to protecting your personal information
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><span className="text-foreground font-medium">Personal Identifiers:</span> Name, email address, phone number, and billing information provided when making a reservation, purchasing a gift card, or contacting us.</li>
              <li><span className="text-foreground font-medium">Reservation & Order Data:</span> Details about your reservations, party size, special requests, and dining preferences.</li>
              <li><span className="text-foreground font-medium">Loyalty Program Data:</span> Points balance, redemption history, and membership tier information.</li>
              <li><span className="text-foreground font-medium">Usage Data:</span> Browser type, IP address, pages visited, and time spent on our website, collected via cookies and analytics tools.</li>
              <li><span className="text-foreground font-medium">Communications:</span> Messages you send us through contact forms or support channels.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>Process and manage reservations, orders, and gift card purchases</li>
              <li>Operate and improve our loyalty program</li>
              <li>Send transactional communications (confirmations, reminders)</li>
          ...
          <section>
            <h2 className="font-heading text-xl font-semibold mb-3">4. Sharing Your Information</h2>
            <p className="mb-3">We do not sell your personal information. We may share your information with:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><span className="text-foreground font-medium">Service Providers:</span> Third-party vendors who assist us with payment processing, email delivery, and analytics, bound by confidentiality obligations.</li>
              <li><span className="text-foreground font-medium">Legal Requirements:</span> When required by law, court order, or governmental authority.</li>
              <li><span className="text-foreground font-medium">Business Transfers:</span> In connection with a merger, acquisition, or sale of assets, with notice to affected users.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              for seven (7) years for accounting and legal compliance purposes.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-card border border-border rounded-xl p-4 space-y-1 text-muted-foreground">
              ...
              <p>Email: <a href="mailto:privacy@jtapkitchen.com" className="text-primary hover:underline">privacy@jtapkitchen.com</a></p>
